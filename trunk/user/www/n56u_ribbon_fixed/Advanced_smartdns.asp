                                    ...
                                    <div id="wnd_sm_cfg">
										...
										<tr> <th width="50%"><#SmartDNS5#></th>
											<td>
												<select name="sdns_redirect" class="input" style="width: 200px">
													<option value="0" <% nvram_match_x("","sdns_redirect", "0","selected"); %>>none</option>
													<option value="1" <% nvram_match_x("","sdns_redirect", "1","selected"); %>>Acts as an upstream server for dnsmasq</option>
													<option value="2" <% nvram_match_x("","sdns_redirect", "2","selected"); %>>Redirect port 53 to SmartDNS</option>
												</select>
											</td>
										</tr>
										...
										<tr> <th width="50%"><#SmartDNS20#></th>
                                            <td>
												...
												<div><span style="color:#888;">For example: none for prohibition ping,tcp:80,tcp:443</span></div>
                                            </td>
                                        </tr>
										...
										<tr> <th width="50%"><#SmartDNS1#></th>
                                            <td>
												...
												<div><span style="color:#888;">For example: oversea, office, home</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%"><#SmartDNS2#></th>
                                            <td>
                                        ...
                                        <tr> <th width="50%">upstream name:</th>
										    <td>
                                        ...
                                        <tr> <th width="50%">upstream address:</th>
										    <td>
                                        ...
                                        <tr> <th width="50%">upstream port:</th>
										    <td>
                                        ...
                                        <tr> <th width="50%">upstream type:</th>
										    <td>
                                        ...
                                        <tr> <th width="50%">IP filtering:</th>
										    <td>
										...
										<tr> <th colspan="2" style="background-color: #E3E3E3;">The specified server group can be used to parse gfwlist alone, if you do not need to cooperate with SS to parse gfwlist, you can leave it blank</th></tr>
										<tr> <th width="50%">Server group (leave blank to not specify):</th>
										    <td>
										...
										<tr> <th width="50%">Add ipset (to be used for parsing gfwlist):</th>
										    <td>
												...
												<div><span style="color:#888;">Note that the IP is filled directly, if it is a domain name</span></div>
												<div><span style="color:#888;">For example:https://dns.google/dns-query</span></div>
											</td>
										</tr>
										<tr> <th width="50%">Exclude servers from default grouping:</th>
										    <td>
                                        ...
                                        <tr id="row_rules_caption">
                                            <th width="10%">enable <i class="icon-circle-arrow-down"></i></th>
											<th width="20%">name <i class="icon-circle-arrow-down"></i></th>
											<th width="20%">address <i class="icon-circle-arrow-down"></i></th>
											<th width="10%">port <i class="icon-circle-arrow-down"></i></th>
											<th width="10%">protocol <i class="icon-circle-arrow-down"></i></th>
											<th width="15%">filter <i class="icon-circle-arrow-down"></i></th>
										...
										<tr> <th width="50%">Load ChnrouteIP as whitelist</th>
                                            <td>
												...
												<div><span style="color:#888;">This item can be used in conjunction with scientific Internet access to realize mainland IP before using domestic DNS</span></div>
												<div><span style="color:#888;">Whitelist filtering needs to be enabled in the domestic group of the upstream server[-whitelist-ip]</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%">Load ChnrouteIP as blacklist</th>
                                            <td>
                                                <div class="main_itoggle">
												...
												<div><span style="color:#888;">This item can be combined with scientific Internet access to realize that mainland IPs are prohibited from using foreign DNS</span></div>
												<div><span style="color:#888;">Blacklist filtering needs to be enabled in the foreign group of the upstream server[-blacklist-ip]</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%">generate coredump</th>
                                            <td>
                                                <div class="main_itoggle">
